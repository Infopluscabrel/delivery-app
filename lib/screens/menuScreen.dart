...
import 'package:egg_delivery_app/screens/dessertScreen.dart';
import 'package:egg_delivery_app/utils/helper.dart';
import 'package:egg_delivery_app/widgets/customNavBar.dart';
import 'package:egg_delivery_app/widgets/searchBar.dart';
            ...
            child: Column(
              children: [
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        "Menu",
                        style: TextStyle(fontSize: 24, color: AppColor.logoBg, fontWeight: FontWeight.bold),
                      ),
                      Image.asset(
                ...
                Row(
                    ...
                    children: [
                      Image.asset(Helper.getAssetName("logo.png", "virtual"),
                          cacheHeight: 80,
                        cacheWidth: 100,
                        fit: BoxFit.contain,
                      )
